      ...
      <main class="app-shell">
        ...
        <aside class="sidebar">
          ...
          <nav>
            ...
            <a *ngIf="auth.hasPermission('users.manage')" routerLink="/users" routerLinkActive="active">
              <span>S</span>
              Sales Accounts
            </a>
            ...
            <a *ngIf="auth.hasPermission('bookings.manage')" routerLink="/properties/projects" routerLinkActive="active">
              <span>P</span>
              Projects
            </a>
